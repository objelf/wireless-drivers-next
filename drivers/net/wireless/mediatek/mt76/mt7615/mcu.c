...
mt7615_mcu_debug_msg_event(struct mt7615_dev *dev, struct sk_buff *skb)
{
	...
	/*
	print_hex_dump(KERN_ERR, "fwlog", DUMP_PREFIX_OFFSET, 32, 8,
		       dbg_msg->msg, dbg_msg->msg_size, true);
	*/

	/* TODO: Integrate the event to debugfs/ftrace */
}
		    ...
		    void *data)
{
	...
	/* we are assuming here to have a signle pairwise key */
