...
enum {
	...
	MCU_EVENT_LINK_QUALITY = 0x02,
	MCU_EVENT_STATISTICS = 0x03,
	MCU_EVENT_MT_PATCH_SEM = 0x04,
	MCU_EVENT_ACCESS_REG2 = 0x05,
	MCU_EVENT_RX_ADDBA = 0x05,
	MCU_EVENT_RX_DELBA = 0x0b,
	MCU_EVENT_SCAN_DONE = 0x0d,
	MCU_EVENT_TX_DONE = 0x0f,
	MCU_EVENT_CH_PRIVILEDE = 0x10,
	MCU_EVENT_BSS_ABSENCE  = 0x11,
	MCU_EVENT_STA_PS_CHANGE = 0x12,
	MCU_EVENT_BEACON_TIMEOUT = 0x13,
	MCU_EVENT_NOA = 0x14,
	MCU_EVENT_AP_OBSS = 0x15,
	MCU_EVENT_ROAMING_INFO = 0x18,
	MCU_EVENT_AGING_TIMEOUT = 0x19,
	MCU_EVENT_MEM_DUMP = 0x20,
	MCU_EVENT_STA_STAT = 0x21,
	MCU_EVENT_SCHED_SCAN_DONE = 0x23,
	MCU_EVENT_GET_GTK_REKEY_DATA = 0x23,
	MCU_EVENT_DBG_MSG = 0x27,
	MCU_EVENT_TX_ADDBA = 0x2e,
	MCU_EVENT_GET_CHIPID = 0x44,
	MCU_EVENT_DEV_CONFIG = 0x45,
	MCU_EVENT_RX_STAT = 0x45,
	MCU_EVENT_CSA_DONE = 0x62,
	MCU_EVENT_WOW_REASON = 0x62,
	MCU_EVENT_ANT_DIV = 0x91,
	MCU_EVENT_RSSI_MON = 0xa1,
	MCU_EVENT_IPI_INFO = 0xcd,
	MCU_EVENT_WTBL_INFO = 0xcd,
	MCU_EVENT_MIB_INFO = 0xce,
	MCU_EVENT_MCS_INFO = 0xcf,
	MCU_EVENT_TXPWR_TBL = 0xd0,
	MCU_EVENT_PCIE_LINK_STATE = 0xda,
	MCU_EVENT_CAPV2 = 0xd0,
	MCU_EVENT_EXT = 0xed,
	MCU_EVENT_ASSERT_DUMP = 0xf0,
	MCU_EVENT_HIF_CTRL = 0xf6,
...
enum {
	...
	MCU_UNI_CMD_SUSPEND_WOW = MCU_UNI_PREFIX | 0x05,
...
enum {
	...
	MCU_CMD_SET_POWER_SAVE_MODE = MCU_CE_PREFIX | 0x05,
	MCU_CMD_SET_CHAN_DOMAIN = MCU_CE_PREFIX | 0x0f,
    MCU_CMD_SET_BSS_PM_CONNECTED = MCU_CE_PREFIX | 0X16,
	MCU_CMD_CANCEL_HW_SCAN = MCU_CE_PREFIX | 0x1b,
	MCU_CMD_SET_CHANNEL_PRI = MCU_CE_PREFIX | 0x1c,
    MCU_CMD_SET_NOA_PARAM = MCU_CE_PREFIX | 0x32,
    MCU_CMD_SET_OPPPS_PARAM = MCU_CE_PREFIX | 0x33,
    MCU_CMD_SET_POWER_LIMIT = MCU_CE_PREFIX | 0x49,
    MCU_CMD_SET_POWER_LIMIT_PER_RATE = MCU_CE_PREFIX | 0x5d,
	MCU_CMD_SCHED_SCAN_ENABLE = MCU_CE_PREFIX | 0x61,
	MCU_CMD_SCHED_SCAN_REQ = MCU_CE_PREFIX | 0x62,
	MCU_CMD_CUSTOM_CONFIG = MCU_CE_PREFIX | 0x70,
	MCU_CMD_COEX_ALWAYS_SCAN = MCU_CE_PREFIX | 0x73,
	MCU_CMD_COEX_CTRL = MCU_CE_PREFIX | 0x7c,
	MCU_CMD_GET_CAP = MCU_CE_PREFIX | 0x80,
	MCU_CMD_GET_LINK_QUALITY = MCU_CE_PREFIX | 0x81,
	MCU_CMD_GET_STA_STATISTICS = MCU_CE_PREFIX | 0x85,
	MCU_CMD_GET_CAP_V2 = MCU_CE_PREFIX | 0x8a,
	MCU_CMD_ACCESS_REG = MCU_CE_PREFIX | 0xc0,
	MCU_CMD_DEVICE_CONFIG = MCU_CE_PREFIX | 0xca,
	MCU_CMD_GET_IPI_INFO = MCU_CE_PREFIX | 0xce,
	MCU_CMD_GET_WTBL_INFO = MCU_CE_PREFIX | 0xcd,
	MCU_CMD_GET_MIB_INFO = MCU_CE_PREFIX | 0xce,
	MCU_CMD_GET_TXPWR_TBL = MCU_CE_PREFIX | 0xd0,
};
