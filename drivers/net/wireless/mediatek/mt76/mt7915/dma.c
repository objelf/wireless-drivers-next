...
mt7915_init_tx_queues(struct mt7915_dev *dev, int n_desc)
{
	...
	err = mt76_queue_alloc(dev, hwq, MT7921_TXQ_BAND0, n_desc, 0,
			       MT_TX_RING_BASE);
	if (err < 0)
		return err;
...
static int mt7921_dmashdl_disabled(struct mt7915_dev *dev)
{
...
int mt7915_dma_init(struct mt7915_dev *dev)
{
	...
	/* Change mcu queue after fimrware download */
	ret = mt76_queue_alloc(dev, &dev->mt76.q_rx[MT_RXQ_MCU_540],
			       MT7915_RXQ_MCU_WM,
