...
static int btusb_recv_acl_mtk(struct hci_dev *hdev, struct sk_buff *skb)
{
	...
	case 0xfc6f:		/* Firmware dump from device */
		...
		/* We need to forward the diagnostic packet to userspace daemon for
		 * backward compability purpose, so we have to extraly clone the skb
		 * for the in-kernel coredump support.
		 */
